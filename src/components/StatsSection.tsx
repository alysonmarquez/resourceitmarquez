...
import { Users, BookOpen, Layers, CheckCircle2, MessageCircle, ExternalLink } from 'lucide-react';
...
export function StatsSection({ isTechGirl }: StatsSectionProps) {
  ...
  const stats = [
    {
      ...
      icon: <Users size={22} className={isTechGirl ? 'text-[#967189]' : 'text-[#246386]'} />,
    ...
    },
    {
      ...
      icon: <BookOpen size={22} className={isTechGirl ? 'text-[#967189]' : 'text-[#246386]'} />
    },
    {
      value: '6',
      label: 'Projetos Práticos',
      desc: 'RecruitAI, Arena Xeque, Enge PRO, SpeedBet, Resource IT Hub e Bot.',
      icon: <Layers size={22} className={isTechGirl ? 'text-[#967189]' : 'text-[#246386]'} />
    },
    {
      value: '100%',
  ...
  return (
    <section id="numeros" aria-labelledby="stats-heading" className="py-16 md:py-24 border-t border-[#E6E9EF]/10">
              ...
              <div>
                ...
                {stat.action && (
                  <button
                    type="button"
                    onClick={stat.action}
                    className={`inline-flex items-center gap-1.5 text-xs font-mono font-medium underline underline-offset-4 cursor-pointer ${
                      isTechGirl ? 'text-[#967189] hover:text-[#E6E9EF]' : 'text-[#246386] hover:text-[#E6E9EF]'
                    }`}
                  >
      ...
      {showGroupsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#030C1E]/85 backdrop-blur-md animate-subir">
          <div className="w-full max-w-2xl bg-[#071528] border border-[#E6E9EF]/15 rounded-2xl p-6 md:p-8 max-h-[85vh] overflow-y-auto shadow-2xl">
            <div className="flex items-center justify-between pb-4 border-b border-[#E6E9EF]/10 mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl border border-[#E6E9EF]/10 bg-[#103653]/40">
                  <MessageCircle size={20} className={isTechGirl ? 'text-[#967189]' : 'text-[#246386]'} />
                </div>
                <div>
              ...
              <button 
                ...
                className="text-[#A1AEC2] hover:text-[#E6E9EF] text-sm font-mono p-2 cursor-pointer"
              >
                ✕ Fechar
              </button>
            </div>
            ...
            <div className="flex flex-col gap-3">
              {groups.map((g) => (
                <div key={g.id} className="p-4 rounded-xl border border-[#E6E9EF]/10 bg-[#030C1E]/50 flex items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-sm font-bold text-[#E6E9EF]">{g.name}</span>
                      <span className="font-mono text-[10px] px-2 py-0.5 rounded-full border border-[#E6E9EF]/10 bg-[#103653]/40 text-[#A1AEC2]">
                        {g.platform}
                      </span>
                    </div>
                  ...
                  <a 
                    ...
                    className="btn-primary shrink-0 px-3.5 py-1.5 text-xs font-semibold text-white"
                  >
                    Acessar
                  </a>
                </div>
